(function( $ ) {
    ...
    $( gamipress_transfers_widget_field_selector( 'points_transfer', 'select_recipient' ) + ', '
        + gamipress_transfers_widget_field_selector( 'achievement_transfer', 'select_recipient' ) + ', '
        + gamipress_transfers_widget_field_selector( 'rank_transfer', 'select_recipient' ) ).change();
    ...
    $('body').on('change', 'select[id^="widget-gamipress_points_transfer"][id$="[transfer_type]"]', function() {
        ...
        if( type === 'fixed' ) {
            ...
            allow_user_input.find('input').change();
        }
    });

    $( 'select[id^="widget-gamipress_points_transfer"][id$="[transfer_type]"]' ).change();
    ...
    $( 'input[id^="widget-gamipress_points_transfer"][id$="[allow_user_input]"]' ).change();
    ...
    $(document).on('widget-updated widget-added', function(e, widget) {
        ...
        widget.find( 'select[id^="widget-gamipress_points_transfer"][id$="[transfer_type]"]' ).change();

        widget.find( 'input[id^="widget-gamipress_points_transfer"][id$="[allow_user_input]"]' ).change();
    });
