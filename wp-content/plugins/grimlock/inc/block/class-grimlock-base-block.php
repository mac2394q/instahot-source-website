...
abstract class Grimlock_Base_Block {
	 ...
	 * @return array Parsed field args
	 */
	public static function image_field( $args ) {
		return wp_parse_args( $args, array(
			'type'           => 'image',
			'name'           => '',
			'label'          => '',
	 ...
	 * @return array Parsed field args
	 */
	public static function toggle_field( $args ) {
		return wp_parse_args( $args, array(
			'type'           => 'toggle',
			'name'           => '',
			'label'          => '',
	 ...
	 * @return array Parsed field args
	 */
	public static function radio_image_field( $args ) {
		return wp_parse_args( $args, array(
			'type'           => 'radioImage',
			'name'           => '',
			'label'          => '',
	 ...
	 * @return array Parsed field args
	 */
	public static function range_field( $args ) {
		return wp_parse_args( $args, array(
			'type'           => 'range',
			'name'           => '',
			'label'          => '',
	 ...
	 * @return array Parsed field args
	 */
	public static function gradient_field( $args ) {
		return wp_parse_args( $args, array(
			'type'           => 'gradient',
			'name'           => '',
			'label'          => '',
