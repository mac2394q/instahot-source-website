...
add_action( 'grimlock_post_card_body',        'grimlock_post_header',    10, 1 );
add_action( 'grimlock_post_card_body',        'grimlock_post_format',    20, 1 );
...
add_action( 'grimlock_post_header',           'grimlock_post_meta',      20, 1 );

add_action( 'grimlock_post_footer',           'grimlock_category_list',  10, 1 );
