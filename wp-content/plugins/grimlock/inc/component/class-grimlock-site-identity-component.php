		...
		if ( $this->is_displayed() ) : ?>
            <div <?php $this->render_class( array( 'site-branding' ) ); ?>>
				...
				if ( true == $this->props['blogname_displayed'] ) : ?>
                    <div class="site-title navbar-brand__title">
                        <a class="site-title-link navbar-brand__title-link" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a>
                    </div><!-- navbar-brand__title -->
					<?php
				endif;

				if ( true == $this->props['blogdescription_displayed'] ) : ?>
                    <small class="site-description navbar-brand__tagline">
