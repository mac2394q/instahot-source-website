...
class Grimlock_Term_Query_Section_Widget_Fields extends Grimlock_Section_Widget_Fields {
	...
	public function __construct( $id_base = 'grimlock_term_query_section_widget' ) {
		...
		add_action( "{$this->id_base}_query_tab",      array( $this, 'add_parent_field'         ), 110, 2 );
		add_action( "{$this->id_base}_query_tab",      array( $this, 'add_number_field'         ), 120, 2 );
		...
		add_action( "{$this->id_base}_query_tab",      array( $this, 'add_hide_empty_field'     ), 140, 2 );
