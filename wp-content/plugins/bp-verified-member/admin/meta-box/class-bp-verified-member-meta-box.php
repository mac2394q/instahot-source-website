...
if ( ! class_exists( 'BP_Verified_Member_Meta_Box' ) ) :
	...
	class BP_Verified_Member_Meta_Box {
		...
		public function render_meta_box() {
			...
			$checked = ! empty( get_user_meta( $user_id, $this->meta_keys['verified'], true ) ) ? 'checked' : '';
			?>
				...
				<tr class="<?php echo esc_attr( $this->meta_keys['verified'] ); ?>-wrap">
					...
					<td>
						<label for="<?php echo esc_attr( $this->meta_keys['verified'] ); ?>">
							<input name="<?php echo esc_attr( $this->meta_keys['verified'] ); ?>" id="<?php echo esc_attr( $this->meta_keys['verified'] ); ?>" type="checkbox" <?php echo esc_attr( $checked ); ?>>
